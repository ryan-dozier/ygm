...
inline void comm::init_trace_file() {
  std::string trace_file = std::string(std::string("~/trace_results/") + std::to_string(m_layout.rank()) + std::string(".csv"));
  std::string trace_filename = config.trace_out_directory;
