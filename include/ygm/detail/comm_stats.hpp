...
class comm_stats {
 public:
  ...
  size_t get_shm_send_count() const { return m_shm_send_count; }
  size_t get_shm_send_bytes() const { return m_shm_send_bytes; }
  ...
  double get_shm_memcpy_time() const { return static_cast<double>(m_shm_wait_memcpy_microseconds) / 1000000.0; }
